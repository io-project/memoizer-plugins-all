...
public class Demoty2DownloadPluginFactory extends CommonDownloadPluginFactory{

	public Demoty2DownloadPluginFactory(){
		super.addView(EViewType.CHRONOLOGICAL, "DemotyChrono", "http://demotywatory.pl/page");
		super.addView(EViewType.UNSEEN, "DemotyChrono", "http://demotywatory.pl/page");
		super.addView(EViewType.QUEUE, "DemotyQueue", "http://demotywatory.pl/poczekalnia/page");
		super.addView(EViewType.FAVOURITE, "DemotyTopPercent", "http://demotywatory.pl/topka/procenty/page");
		super.addView(EViewType.RANDOM, "DemotyRandom", "http://demotywatory.pl/losuj");
		super.addView(EViewType.SEARCH, "DemotySearch", "http://demotywatory.pl/szukaj/page?q=");
	}
	...
	public IDownloadPlugin newInstance(IStateObject pluginState,
		...
		return super.newInstance(pluginState, viewType, new Demoty2MemeDownloader());
	}

	@Override
	public IDownloadPlugin newInstance(IStateObject pluginState,
			EViewType viewType, Object parameters) throws InvalidViewException {
		return super.newInstance(pluginState, viewType, parameters, new Demoty2MemeDownloader());
	}
